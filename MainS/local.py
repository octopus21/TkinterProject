        ...
        with open(creds) as f:
            ...
            if sifregiris1.get() == sifre and isimgiris1.get() == isim:
                ...
                def sourcevv():
                    ...
                    sourcev1()
                    pass
                serverpaneldugme = Button(den, text="Sunucuyu kayıt ettir.",command=sourcevv)
                serverpaneldugme.grid(row=1, column=2)

    def sourcev1():
        sourcet = Tk()
        sourcetimg = PhotoImage(file="D:\şeker.png")
        labels1 = Label(sourcet, image=sourcetimg)
        labels1.pack()
        sourcet.mainloop()
